...
- (void)viewDidLoad
{
    ...
    [self.kamionSearchBar setShowsScopeBar:NO];
    [self.kamionSearchBar sizeToFit];
    [self.kamionSearchBar setTintColor:UIColorFromRGB(0x260B01)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *CellIdentifier = @"kamionCell";
...
{
    if ( [[segue identifier] isEqualToString:@"vehiclesKamionDetails"] ) {
    ...
    else if ( [[segue identifier] isEqualToString:@"kamionAdminViewSegue"] )
    {
...
-(void)rendezNev
{
    self.cellLabelName = [NSMutableArray arrayWithArray:[DataBaseUtil fetchRequestJarmu:@"Auto" :@"1" :@"autoIsActive" :@"Kamion" :@"autoNev" :[NSNumber numberWithInt:1]]];
    [[self tableView] reloadData];
}

-(void)rendezRendszam
{
    self.cellLabelName = [NSMutableArray arrayWithArray:[DataBaseUtil fetchRequestJarmu:@"Auto" :@"1" :@"autoIsActive" :@"Kamion" :@"autoRendszam" :[NSNumber numberWithInt:1]]];
    [[self tableView] reloadData];
}

-(void)frissit {
    self.cellLabelName = [NSMutableArray arrayWithArray:[DataBaseUtil fetchRequestJarmu:@"Auto" :@"1" :@"autoIsActive" :@"Kamion"]];
    self.filteredArray = [NSMutableArray arrayWithCapacity:[self.cellLabelName count]];
    [[self tableView] reloadData];
}
@end
