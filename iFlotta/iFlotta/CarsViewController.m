...
-(void)rendezNev
{
    self.cellLabelName = [NSMutableArray arrayWithArray:[DataBaseUtil fetchRequestJarmu:@"Auto" :@"1" :@"autoIsActive" :@"Személygépjármű" :@"autoNev" :[NSNumber numberWithInt:1]]];
    [[self tableView] reloadData];
}

-(void)rendezRendszam
{
    self.cellLabelName = [NSMutableArray arrayWithArray:[DataBaseUtil fetchRequestJarmu:@"Auto" :@"1" :@"autoIsActive" :@"Személygépjármű" :@"autoRendszam" :[NSNumber numberWithInt:1]]];
    [[self tableView] reloadData];
}

-(void)frissit {
    self.cellLabelName = [NSMutableArray arrayWithArray:[DataBaseUtil fetchRequestJarmu:@"Auto" :@"1" :@"autoIsActive" :@"Személygépjármű"]];
    self.filteredArray = [NSMutableArray arrayWithCapacity:[self.cellLabelName count]];
    [[self tableView] reloadData];
}
