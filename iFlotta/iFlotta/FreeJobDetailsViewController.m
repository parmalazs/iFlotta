...
- (void)viewDidLoad
{
    ...
    // ITT LEKÉRDEZNI
    NSArray * tmp = [DataBaseUtil fetchRequestMunkaTipus:[[[self freeJobData] valueForKey:@"munkatipusID"] stringValue]];
    ...
    self.jobAttribute2.text = [[self.freeJobData valueForKey:@"munkaUzemanyagState"] stringValue];
    self.jobAttribute2.backgroundColor = UIColorFromRGB(0xD9B384);
    self.jobAttribute2.textColor = UIColorFromRGB(0x260B01);
    
    self.jobAttribute3.text = [[self.freeJobData valueForKey:@"munkaBevetel"] stringValue];
    self.jobAttribute3.backgroundColor = UIColorFromRGB(0xD9B384);
    self.jobAttribute3.textColor = UIColorFromRGB(0x260B01);
    self.jobAttribute4.text = [[self.freeJobData valueForKey:@"munkaKoltseg"] stringValue];
    ...
    self.jobAttribute5.text = [self.freeJobData valueForKey:@"munkaComment"];
